...
class ArrivalAdapter (val context: Context, val arrivals: List<Arrival>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArrivalAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ArrivalAdapter.ViewHolder, position: Int) {
